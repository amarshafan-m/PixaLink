...
const isProduction = process.env.NODE_ENV === "production" || process.env.npm_lifecycle_event === "build" || process.env.ZXP_PACKAGE === "true" || process.env.ZIP_PACKAGE === "true";
...
// Determine if we should obfuscate
const enableObfuscation = isProduction;
